		...
		public async Task Seed()
		{
			...
			if (!_context.Functions.Any())
			{
				_context.Functions.AddRange(new List<Function>
				{
					...
					new Function { Id = "STATISTICS", Name = "Thống Kê", ParentId = null, Url = "/statistic" },

					new Function { Id = "STATISTICS_MONTHLY_NEWMEMBER", Name = "bài đăng từng tháng", ParentId = "STATISTICS", SortOrder = 1, Url = "/statistic/monthly-register" },
					new Function { Id = "STATISTICS_MONTHLY_NEWKB", Name = "Bài đăng hàng tháng", ParentId = "STATISTICS", SortOrder = 2, Url = "/statistic/monthly-newkb" },
					new Function { Id = "STATISTICS_MONTHLY_COMMENT", Name = "Comment theo tháng", ParentId = "STATISTICS", SortOrder = 3, Url = "/statistic/monthly-comment" },
